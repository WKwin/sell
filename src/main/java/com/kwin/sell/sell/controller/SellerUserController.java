...
public class SellerUserController {
    ...
    public ModelAndView login(@RequestParam("openid") String openid,
        ...
        log.info("login");
        if (sellerInfo == null) {
        	log.info("【login】:" + ResultEnum.LOGIN_FAIL.getMessage());
        ...
        //3. 设置token至cookie
        CookieUtil.set(response, CookieConstant.TOKEN, token, expire);//CookieConstant.EXPIRE

//        return new ModelAndView("redirect:" + projectUrlConfig.getSell() + "/sell/seller/order/list");
        return new ModelAndView("redirect:" + "http://192.168.3.6:8080/sell/seller/order/list");
